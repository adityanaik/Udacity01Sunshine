...
public class MainActivity extends AppCompatActivity implements ForecastFragment.Callback {
    ...
    /**
     * Substitute your own number here. This project number comes from
     * the Google Developers Console.
     */
    static final String PROJECT_NUMBER = "513776580814";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * If Google Play Services is not available, some features, such as
         * GCM-powered weather alerts, will not be available.
         */
        if (checkPlayServices()) {
            ...
            if (PROJECT_NUMBER.equals("Your Project Number")) {
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("GCM will not function in Sunshine until you set the Project Number " +
                                "to the one from the Google Developers Console.")
    ...
    protected void onResume() {
        ...
        // If Google Play Services is not available, some features, such as GCM-powered weather alerts,
        // will nto be available.
        if (!checkPlayServices()) {
            // Store regID as null
        }
     ...
     * If it doesn't, display a dialog to allow users to download the APK
     ...
     *
     * @param context
     * @return registration ID, or empty string if there's no existing registration ID.
     */
    ...
    private SharedPreferences getGCMPreferences(Context context) {
        ...
        // how you store the registration ID in your app is upto you. Just make sure
        // that it is private!
