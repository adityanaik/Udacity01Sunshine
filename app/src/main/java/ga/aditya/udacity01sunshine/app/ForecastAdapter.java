...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    * Cache of the children views for a forecast list item
    ...
    /**
     * This takes advantage of the fact that the viewGroup passed to onCreateViewHolder is
     * the RecyclerView that will be used to contain the view, so that it can get
     * the current ItemSelectionManager from the view.
     * <p/>
     * One could implement this pattern without modifying RecyclerView by taking advantage of
     * the view tag to store the ItemChoiceManager.
     */
    @Override
