...
public class Utility {
    ...
    public static String getFormattedWind(Context context, float windSpeed, float degrees) {
        ...
        //From wind direction in degrees, determine compass direction as a string(eg. N, S, NW)
     ...
     *
     * @param weatherId from OpenWeatherMap API response
     * @return URL for the corresponding image. -1 if no relation is found.
     */
    public static int getArtUrlForWeatherCondition(int weatherId) {
        // Based on weather code data found at:
        // http://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_Codes
        if (weatherId >= 200 && weatherId <= 232) {
            return R.drawable.art_storm;
    ...
    /**
     * @param context Context used to get the SharedPreferences from
     * @return the location status interger type
     */
     ...
     *
     * @param context used to get SharedPreferences from.
     */
    public static void resetLocationStatus(Context context) {
        ...
        editor.apply(); // apply() instead of commit(), because it will be called from UiThread.
    }
